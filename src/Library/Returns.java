...
public class Returns extends javax.swing.JInternalFrame {
    ...
    public Returns(Data d, String id, Users user) {
        initComponents();
        this.data = d;
        this.idStudent = id;
        this.users = user;
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jb_Cancel, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(132, 132, 132))
        );
...
//------------------------------------------------------------------------------
    ...
    private void sameIDStudent() {
        for (String[] article : data.getBooks()) {
            if (article[9].equals(idStudent)) {
    ...
    private void actualizationDataB() {
      String[] field = data.getBook(tf_Code.getText());
                ...
                if (field[4].equals("Not Available")) {
                    ...
                    JOptionPane.showMessageDialog(null, "The book must be not avavilable if you want to return it");
                }
    }

    private void actualizationDataM() {
         String[] field = data.getMagazine(tf_Code.getText());
                ...
                if (field[4].equals("Not Available")) {
                    ...
                    JOptionPane.showMessageDialog(null, "The Magazine must be not avavilable if you want to return it");
                }
    }
//------------------------------------------------------------------------------
